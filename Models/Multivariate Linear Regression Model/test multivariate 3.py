...
pred_data = pd.DataFrame({
    ...
    'event_type_Explosions_Remote_violence': y.ravel()
})

# Ensure all other sub_event_type columns are zero in the prediction data
for col in clean_data_encoded.columns:
    if col.startswith('event_type_') and col != 'event_type_Explosions_Remote_violence':
        pred_data[col] = 0
...
ax.scatter(
    ...
    clean_data_encoded['event_type_Explosions_Remote_violence'], 
...
ax.set_ylabel('Attack Type (Explosions/Remote Violence)')
